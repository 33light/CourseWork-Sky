...
@login_required
def team_summary(request, team_id, session_id=None):
    user_profile = request.user.profile
    
    # Check if user is authorized to view team summary
    ...
    # If department leader, check if team is in their department
    if user_profile.role == 'department_leader':
        if user_profile.team and user_profile.team.department != team.department:
    ...
    # Get votes for each card and session
    summary_data = {}
